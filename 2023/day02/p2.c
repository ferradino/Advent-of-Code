    ...
    for (int i = 0; i < num_games; i++){
        ...
        while (strlen(contents[i]) + 1 > idx) {
            ...
            // Means we got a cube, need the number and color
                ...
                game.max_red = (game.max_red >= game.red) ? game.max_red : game.red;
                game.max_blue = (game.max_blue >= game.blue) ? game.max_blue : game.blue;
                game.max_green = (game.max_green >= game.green) ? game.max_green : game.green;
        ...
        min_cubes += (game.max_red * game.max_green * game.max_blue);
        game.max_red = game.max_green = game.max_blue = 0;
